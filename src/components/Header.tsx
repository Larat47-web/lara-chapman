...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FAF8F5]/95 backdrop-blur-sm border-b border-[#2F4F4F]/10 transition-all duration-300 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 gap-2">
          <div className="flex items-center space-x-1 sm:space-x-2 min-w-0 flex-shrink">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-[#2F4F4F] font-playfair whitespace-nowrap">
              Lara Chapman
            </h1>
            <span className="text-[#E67E22] font-medium font-inter text-sm sm:text-base whitespace-nowrap hidden sm:inline">| Bliss Realty</span>
          </div>
          ...
          <button
            ...
            className="lg:hidden bg-[#E67E22] text-white p-2 rounded-xl hover:bg-[#E67E22]/90 transition-colors duration-200 flex-shrink-0"
          >
